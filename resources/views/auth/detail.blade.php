...
<article class="page-container">
	<form class="form form-horizontal" id="form-city-add" method="post" action="{{ URL::route('auth.update') }}">
	<input name="id" value="{{$auth->id}}" type="hidden">
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>模块名称：</label>
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" value="{{$auth->name}}" placeholder="" name="name">
		</div>
	</div>
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>节点名称：</label>
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" value="{{$auth->en_name}}" placeholder="" name="en_name">
		</div>
	</div>
	<div class="row cl">
