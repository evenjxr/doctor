...
<article class="page-container">
	<form class="form form-horizontal" id="form-city-add" method="post" action="{{ URL::route('auth.store') }}">
	<div class="row cl">
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" value="" placeholder="" name="en_name">
		</div>
	</div>
	<div class="row cl">
