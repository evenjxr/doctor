...
UE.I18N['en'] = {
    ...
    'autoupload': {
        ...
        'jsonEncodeError': 'Services Return Format Error',
        'loading':"loading...",
        'loadError':"load error",
        'errorLoadConfig': 'Services config not loaded, upload can not work.',
    },
    'simpleupload':{
        'exceedSizeError': 'File Size Exceed',
        'exceedTypeError': 'File Type Not Allow',
    ...
    'loadconfigFormatError': 'Services config format error.',
    ...
    'insertimage':{
        ...
        'errorServerUpload':'Services Result Error.',
    ...
    'insertvideo':{
        ...
        'serverIOError':'Services IO error！',
